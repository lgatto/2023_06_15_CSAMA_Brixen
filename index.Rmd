...
### Slides available at [https://bit.ly/CSAMA2022](https://bit.ly/CSAMA2022) (CC-BY)
...
```{r echo=FALSE, out.width='95%', fig.align = 'center'}
knitr::include_graphics('https://rformassspectrometry.github.io/docs/img/raw.png')
```
---
class: middle
...
- Quantitation data at the PSM or peptide level.
...
> hl <- aggregateFeatures(hl, "psms", "Sequence", name = "peptides", fun = colMeans) |>
       aggregateFeatures("peptides", "ProteinGroupAccessions", name = "proteins", fun = colMeans)
> hl
